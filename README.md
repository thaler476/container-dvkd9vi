...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-dvkd9vi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-dvkd9vi.containers.anotherwebservice.com/
...
```
git clone git@github.com:thaler476/container-dvkd9vi.git
cd container-dvkd9vi
```
...
```
docker attach container-dvkd9vi
```
